...
public class Pilot_Toy_Skill : MonoBehaviour, Skill
{
    public float 지속시간;
    int reset_stat;
    ...
    public void Skill_Action()
    {
        ...
        reset_stat = (int)(Player.GetComponent<Player_Stat>().Get_P_State(2) * 0.1f);
        Debug.Log("장난감 스킬발사 히히");
        Is_Action = true;
