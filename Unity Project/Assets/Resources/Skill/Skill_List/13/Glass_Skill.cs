...
public class Glass_Skill : MonoBehaviour, Skill
{
    public float 지속시간;
    int reset_stat1;
    ...
    public void Skill_Action()
    {
        ...
        reset_stat1 = (int)(Player.GetComponent<Player_Stat>().Get_P_State(5) * 1.0f);
        Debug.Log("안경 스킬발사 히히");
        Player.GetComponent<Player_Stat>().Set_P_State(5, Player.GetComponent<Player_Stat>().Get_P_State(5) + reset_stat1);
        Invoke("Buffe", 지속시간);
    }
    void Buffe()
    {
