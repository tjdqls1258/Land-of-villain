...
public class 大劍_Skill : MonoBehaviour, Skill
{
    GameObject Player;
    ...
    public void Skill_Action()
    {
        ...
        GameObject skills = Instantiate(Skill_Bullte, Player.transform.position, Quaternion.AngleAxis(angle - 45, Vector3.forward));
